...
public class VideoCategoryActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{

    private List<RVideoCategory> cateList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cateList = RealmController.with(this).getVideoCategories();
        ...
        categoryAdapter = new VideoCategoryAdapter(cateList, this);
    ...
    private List<RVideoCategory> filter(List<RVideoCategory> models, String query) {
        query = query.toLowerCase();
        final List<RVideoCategory> filteredModelList = new ArrayList<>();
        for (RVideoCategory model : models) {
    ...
    public boolean onQueryTextChange(String newText) {
        final List<RVideoCategory> filteredModelList = filter(cateList, newText);
