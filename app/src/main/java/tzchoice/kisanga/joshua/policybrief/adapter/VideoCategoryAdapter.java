...
import tzchoice.kisanga.joshua.policybrief.activity.VideoActivity;
...
public class VideoCategoryAdapter extends RecyclerView.Adapter<VideoCategoryAdapter.MyViewHolder> {
    ...
    private List<RVideoCategory> categories;
    Activity activity;
    ...
    public VideoCategoryAdapter(List<RVideoCategory> categoryList, Activity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final RVideoCategory category = categories.get(position);
    ...
    public void setFilter(List<RVideoCategory> cates) {
