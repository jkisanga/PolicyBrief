...
import tzchoice.kisanga.joshua.policybrief.adapter.DocumentsAdapter;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    private List<RDocument> documentList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // documentList = db.documentList(category_id);

        documentList = RealmController.with(this).getDocuments(category_id);
        mAdapter = new DocumentsAdapter(documentList, this);
...
//        startActivity(intent);
    ...
    private List<RDocument> filter(List<RDocument> models, String query) {
        query = query.toLowerCase();
        final List<RDocument> filteredModelList = new ArrayList<>();
        for (RDocument model : models) {
    ...
    public boolean onQueryTextChange(String newText) {
        final List<RDocument> filteredModelList = filter(documentList, newText);
